...
export default function AboutProjectPage() {
  const processes = ['Поступление оборудования на баланс', 'Закрепление за сотрудником', 'Возврат и история выдач', 'Ремонтная заявка и завершение ремонта', 'Инвентаризация: найдено, перемещено, повреждено, отсутствует', 'Audit log, уведомления и CSV-отчёты'];
