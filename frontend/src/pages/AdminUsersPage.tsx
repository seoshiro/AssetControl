...
export default function AdminUsersPage() {
  ...
  return (
    <PageContainer>
      <PageHeader title="Пользователи и роли" description="RBAC: ADMIN, MANAGER, INVENTORY_MANAGER, EMPLOYEE, AUDITOR, VIEWER." />
      <TablePanel>
